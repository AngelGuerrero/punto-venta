...
public class Sales_Controller extends App implements Initializable {
    ...
    public void updateData() {
        String query = "";
        if (!articleTextfield.getText().isEmpty() && !priceTextfield.getText().isEmpty() && !brandTextfield.getText().isEmpty()) {
